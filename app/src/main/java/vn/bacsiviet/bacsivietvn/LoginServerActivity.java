...
public class LoginServerActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginServerActivity.this, MainServerActivity.class);
...
//                        String uid = jObj.getString("user_id");
                        ...
                        int status = user.getInt("user_status");
                        int uTypeId = user.getInt("user_type_id");
                        String created_at = user.getString("created_at");

                        // Inserting row in users table
                        db.addUser(uid, name, email, phone, avatar, gender, status, uTypeId, created_at);

                        // Launch main activity
                        Intent intent = new Intent(LoginServerActivity.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
