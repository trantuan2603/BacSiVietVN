...
import vn.bacsiviet.bacsivietvn.AppService.AppConfig;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(uid, name,email,null,null, 0, 0, 0, created_at);
